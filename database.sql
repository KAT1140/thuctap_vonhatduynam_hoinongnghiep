 ...
 * ============================================
 * Role: admin (quản trị viên), to_hoi (trưởng tổ), hoi_vien (hội viên)
 */
CREATE TABLE users (
    ...
    organization_id INT COMMENT 'ID tổ chức quản lý (nếu là to_hoi)',
    role ENUM('admin', 'to_hoi', 'hoi_vien') DEFAULT 'hoi_vien' COMMENT 'Vai trò',
 ...
 * ============================================
 * Cấp bậc: Xã -> Chi Hội -> Tổ Hội
 * Ví dụ: Hưng Mỹ -> Chi Hội Linh Xuân -> Hội Ấp Đa Hòa
 */
CREATE TABLE organizations (
    ...
    parent_id INT COMMENT 'ID tổ chức cha (xã hoặc chi hội)',
...
CREATE TABLE members (
    ...
    -- Tổ chức & Phân loại
    organization_id INT NOT NULL COMMENT 'ID tổ hội',
    hamlet_name VARCHAR(150) COMMENT 'Tên ấp (deprecated - dùng org_name)',
